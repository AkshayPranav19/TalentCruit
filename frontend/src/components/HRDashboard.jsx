...
//       try {
//         const res = await axios.get('http://localhost:3001/get-all-users');
...
//   if (loading) return <div className="text-center p-8">Loading applicants...</div>;
//   if (error) return <div className="text-red-500 text-center p-8">{error}</div>;
//   if (!applicants.length) return <div className="text-center p-8">No applicants found</div>;

//   return (
//     <div className="p-6">
//       <h1 className="text-2xl font-bold mb-4 text-center">HR Dashboard - All Applicants</h1>
...
//             <th className="border p-2">Resume Done</th>
//             <th className="border p-2">Coding Done</th>
//             <th className="border p-2">ML Score</th>
//             <th className="border p-2">Code Score</th>
//             <th className="border p-2">Total Score</th>
//             <th className="border p-2">GPT Feedback</th>
...
//               <td className="border p-2 text-center">{a.completed_resume ? '✅' : '❌'}</td>
//               <td className="border p-2 text-center">{a.completed_coding ? '✅' : '❌'}</td>
//               <td className="border p-2 text-center">{a.mlScore}</td>
//               <td className="border p-2 text-center">{a.codeScore}</td>
//               <td className="border p-2 text-center">{a.totalScore}</td>
//               <td className="border p-2 max-w-xs truncate">{a.gptFeedback}</td>
//               <td className="border p-2 text-center capitalize">{a.accepted}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
